...
| 역할 | 담당 | 주요 산출물 |
|---|---|---|
| **데이터 전처리** | 이선희 · 박지훈 | 8-Step 공통 파이프라인, 파생변수 9종, Train/Holdout 시간분할 |
...
| **비즈니스 케이스 스터디** | 강인수 | 네이버페이 · Wayfair 적용 사례 조사 |
| **대시보드 구상 및 구현** | 이선희 | FastAPI + Streamlit 5개 탭, 매출 시뮬레이터 |
| **발표자료(PPT) 제작** | 강인수 | 최종 발표 덱 19장 |
