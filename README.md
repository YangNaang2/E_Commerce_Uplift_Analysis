...
FRESH.DATA의 월매출은 9월(30일 환산 8.22억원)을 정점으로 10월에 -8.8% 꺾였습니다. 같은 달 국내 온라인 음식료품 카테고리 전체의 전년동월대비 성장률도 17.7%에서 4.4%로 함께 급락해, 우리 회사만의 문제가 아니라 업계 전체가 같은 시기에 겪은 하락이라는 걸 보여줍니다 — 그래서 이 시기를 위기가 아니라 남들보다 먼저 체질을 개선할 기회로 봅니다.

<img src="assets/05_매출추이_비교.png" alt="FRESH.DATA 월별 매출과 국내 온라인 음식료품 카테고리 성장률 비교 그래프" width="650">
